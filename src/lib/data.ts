export const PRODUCTS = [
  {
    ...
    models: [
      ...
      { id: "m3", name: "Samsung Galaxy S24 Ultra", slug: "samsung-galaxy-s24-ultra", brand: "Samsung" },
    ],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    models: [
      ...
      { id: "m2", name: "Samsung Galaxy S24", slug: "samsung-galaxy-s24", brand: "Samsung" },
  ...
  },
  {
    ...
    description: "Ultra-slim silhouette with a luminous metallic champagne rose sheen. Precision tactile button covers.",
    price: "69",
    comparePrice: "89",
