...
const BRANDS = ["All", "iPhone", "Samsung", "Google"];
const SORT_OPTIONS = [
...
export default function ShopPage() {
  ...
  let filtered =
    activeBrand === "All"
      ? [...PRODUCTS]
      : PRODUCTS.filter((p) =>
          p.modelName.toLowerCase().includes(activeBrand.toLowerCase())
        );
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
      ...
      <p className="mt-2 text-warm-gray">Find the perfect case for your phone</p>
