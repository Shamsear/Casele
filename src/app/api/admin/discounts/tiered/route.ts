...
const DEFAULT_TIERS = [
  { id: "tier-1", minAmount: 50, discountPercent: 5, isActive: true, sortOrder: 0 },
  { id: "tier-2", minAmount: 100, discountPercent: 10, isActive: true, sortOrder: 1 },
  { id: "tier-3", minAmount: 200, discountPercent: 15, isActive: true, sortOrder: 2 },
];

// ─── GET: Fetch all Tiered Discounts ───────────────────────────
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.warn("DB tier discounts fetch failed, returning defaults:", e);
    }
...
// ─── PUT: Update Existing Tiered Discount ───────────────────────
