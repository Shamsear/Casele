    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      <div className="mb-12 pb-6 border-b border-dark-border">
        ...
        <p className="mt-2 text-xs sm:text-sm text-warm-gray">
          {products.length} {products.length === 1 ? "case" : "cases"} engineered specifically for this device
        </p>
      </div>
      ...
      {products.length === 0 && (
        <div className="py-24 text-center border border-dark-border bg-[#0D0D0D]">
          <p className="text-sm uppercase tracking-widest text-white font-medium">No cases found for this model</p>
          <p className="mt-1 text-xs text-warm-gray">Browse other phone models in the catalog</p>
          <a
            href="/shop"
