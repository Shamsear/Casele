...
export function MobileHeader() {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-40 md:hidden border-b border-neutral-200/80 bg-white/85 backdrop-blur-xl saturate-180 shadow-2xs transition-all duration-300">
      <div className="flex h-14 items-center justify-between px-3 sm:px-4 gap-2">
        {!isSearchOpen ? (
          ...
          <div className="flex-1 flex items-center gap-2 animate-scale-in">
            <div className="flex-1 flex items-center gap-2 rounded-full border border-neutral-300 bg-neutral-100 px-3 py-1.5 shadow-2xs">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-neutral-950 placeholder:text-neutral-500 border-0 outline-none ring-0 focus:outline-none focus:ring-0 focus:border-0 p-0 text-xs font-medium"
              />
              {query && (
                <button onClick={() => setQuery("")} className="text-neutral-500 hover:text-neutral-950 p-0.5" aria-label="Clear search">
            ...
            <button
              ...
              className="text-xs font-bold text-neutral-800 hover:text-neutral-950 px-2 py-1 cursor-pointer"
            >
              Cancel
            </button>
          </div>
      ...
      {isSearchOpen && (
        <div className="border-t border-neutral-200 bg-white shadow-2xl max-h-[75vh] overflow-y-auto p-4 animate-scale-in">
          {query.trim().length === 0 ? (
