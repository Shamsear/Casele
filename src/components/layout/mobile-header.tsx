...
export function MobileHeader() {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-40 md:hidden border-b border-white/40 bg-white/55 backdrop-blur-2xl saturate-180 shadow-[0_4px_30px_rgba(0,0,0,0.03)] transition-all duration-300">
      <div className="flex h-14 items-center justify-between px-3 sm:px-4 gap-2">
        {!isSearchOpen ? (
          <>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full border border-white/80 bg-white/80 backdrop-blur-md text-neutral-700 hover:text-neutral-950 transition-colors shadow-2xs cursor-pointer"
              >
          ...
          <div className="flex-1 flex items-center gap-2 animate-scale-in">
            <div className="flex-1 flex items-center gap-2 rounded-full border border-neutral-300 bg-white/90 backdrop-blur-md px-3 py-1.5 shadow-2xs">
      ...
      {isSearchOpen && (
        <div className="border-t border-white/60 bg-white/90 backdrop-blur-2xl shadow-2xl max-h-[75vh] overflow-y-auto p-4 animate-scale-in">
          {query.trim().length === 0 ? (
