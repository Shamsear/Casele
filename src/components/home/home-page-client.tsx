        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-20 w-full lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div
                className={`flex items-center gap-6 pt-4 transition-all duration-500 delay-300 ${
                  mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                }`}
              >
                {[
                ...
                <div className="relative">
                  ...
                  {featured[1] && (
                    <div className="absolute -top-4 -right-4 rounded-xl border border-dark-border bg-dark-surface/80 px-3 py-2 backdrop-blur-sm">
                      <p className="text-xs text-gold font-medium">{featured[1].badge?.toUpperCase() || "NEW"}</p>
                      <p className="text-[10px] text-warm-gray">{featured[1].name}</p>
                    </div>
                  )}
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-6">
          {models.map((model, i) => (
            ...
            >
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full border border-dark-border bg-black text-gold transition-colors group-hover:border-gold/30">
                <PhoneIcon size={18} />
              </div>
