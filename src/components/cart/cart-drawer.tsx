        ...
        {items.length > 0 && (
          <div className="border-t border-dark-border px-6 py-4 space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gold px-6 py-4 text-sm font-semibold text-black transition-all hover:bg-gold-light active:scale-[0.98]"
            >
